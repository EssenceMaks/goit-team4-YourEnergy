var z=Object.defineProperty;var j=(s,t,e)=>t in s?z(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var A=(s,t,e)=>j(s,typeof t!="symbol"?t+"":t,e);import{a as _}from"./vendor-CNNbG8jS.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function e(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=e(r);fetch(r.href,a)}})();const b=()=>"https://your-energy.b.goit.study/api",L=()=>b()+"/exercises",rt=()=>b()+"/filters",it=()=>b()+"/quote",V=()=>b()+"/subscription",at=(s,t,e,i,r,a)=>`${L()}?bodypart=${s}&muscles=${t}&equipment=${e}&keyword=${i}&page=${r}&limit=${a}`,ot=()=>V(),G=s=>`${L()}/${s}`,nt=s=>`${L()}/${s}/rating`,m="/goit-team4-YourEnergy/assets/icons-BTIkT1Ap.svg";function R(s){return typeof s=="string"&&s.length>0?s.charAt(0).toUpperCase()+s.slice(1):s}function C(s){return s.sort((t,e)=>t.name.localeCompare(e.name)).map(({_id:t,name:e,burnedCalories:i,bodyPart:r,target:a,gifUrl:o,rating:n})=>{const u=Math.round(n).toFixed(1);return`
          ...
          </li>`}).join("")}const M=(s,t)=>{let e=new DocumentFragment;for(let i=0;i<s;i++){let r=document.createElement("p");r.setAttribute("data-index",i),r.innerHTML=i+1,r.classList.add("pagination-page"),i===t&&r.classList.add("selected"),e.appendChild(r)}return e},K=()=>{document.querySelectorAll(".pagination").forEach(t=>{if(t.hasAttribute("data-total")){t.innerHTML="";const e=parseInt(t.getAttribute("data-total")),i=parseInt(t.getAttribute("data-current"));t.appendChild(M(e,i)),t.addEventListener("click",async a=>{a.target.classList.contains("pagination-page")&&(a.preventDefault(),t.querySelectorAll(".pagination-page").forEach(n=>{n.classList.remove("selected")}),a.target.classList.add("selected"),t.setAttribute("data-current",a.target.getAttribute("data-index")))}),new MutationObserver(a=>{for(let o of a)if(o.type==="attributes"&&o.attributeName==="data-total"){const n=parseInt(t.getAttribute("data-total")),d=parseInt(t.getAttribute("data-current"));t.innerHTML="",t.appendChild(M(n,d))}}).observe(t,{attributes:!0})}})};document.addEventListener("DOMContentLoaded",K);function Y(s){let t=JSON.parse(localStorage.getItem("favorites"))||[];t=t.filter(e=>e.id!==s),localStorage.setItem("favorites",JSON.stringify(t))}const H="M6.04894 0.927052C6.3483 0.0057416 7.6517 0.00574088 7.95106 0.927052L8.79611 3.52786C8.92999 3.93989 9.31394 4.21885 9.74717 4.21885H12.4818C13.4505 4.21885 13.8533 5.45846 13.0696 6.02786L10.8572 7.63525C10.5067 7.8899 10.3601 8.34127 10.494 8.75329L11.339 11.3541C11.6384 12.2754 10.5839 13.0415 9.80017 12.4721L7.58779 10.8647C7.2373 10.6101 6.7627 10.6101 6.41222 10.8647L4.19983 12.4721C3.41612 13.0415 2.36164 12.2754 2.66099 11.3541L3.50604 8.75329C3.63992 8.34127 3.49326 7.8899 3.14277 7.63525L0.930391 6.02787C0.146677 5.45846 0.549452 4.21885 1.51818 4.21885H4.25283C4.68606 4.21885 5.07001 3.93989 5.20389 3.52786L6.04894 0.927052Z",E=(s=0)=>{let t=Date.now()+Math.random();return`<div style="width: 18px; display: flex; justify-content: center; align-items: center">
    <svg id="starSVG" width="14" height="14" viewBox="0 0 14 14">
      ...
      `,i.classList.remove("is-favorite"))}close(){this.isOpen=!1,this.backdrop&&this.backdrop.classList.add("is-hidden"),this.ratingBackdrop&&(this.ratingBackdrop.classList.add("is-hidden"),this.ratingForm&&this.ratingForm.reset()),document.onkeydown=this.originalEscapeHandler,document.body.style.overflow=""}async updateContent(t){const{_id:e,name:i,rating:r,target:a,bodyPart:o,equipment:n,popularity:d,burnedCalories:u,description:k,gifUrl:x,time:U=3}=t,q=this.backdrop.querySelector(".modal-title");q&&(q.textContent=R(i));const F=this.backdrop.querySelector(".modal-media-container");F&&x&&(F.innerHTML=`<img src="${x}" alt="${i}" />`);const D={Target:a,"Body Part":o,Equipment:n,Popular:d,"Burned Calories":`${u} / ${U} min`},w=this.backdrop.querySelector(".modal-parameters");w&&(w.innerHTML="",Object.entries(D).forEach(([J,W])=>{const S=document.createElement("li");S.className="parameter-item",S.innerHTML=`
